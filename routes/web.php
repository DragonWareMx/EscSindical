...
Route::post('/asignacion/{aid}/estudiante/{eid}', [App\Http\Controllers\CourseController::class, 'asignacionEntregaCalificar'])->name('cursos.asignacion.entrega.calificar');
