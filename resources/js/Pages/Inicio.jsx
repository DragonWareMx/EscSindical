                    ...
                    <div className="row" style={{"marginBottom":"0px"}}>
                        <div className="col s12">
                          <div className="col s12 m6">
                            ...
                            <div className="col s12 txt-prov">Encuentra el curso adecuado para ti y unete a la clase, Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed eiusmod tempor. </div>
