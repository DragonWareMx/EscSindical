  ...
  return (
    <>
        <div className="row">
            ...
            <div className="col s12 m3 l2 xl2 right" style={{"textAlign":"right"}}><InertiaLink className="link-solicitudes">Solicitudes<i className="material-icons tiny" style={{"marginLeft":"10px"}}>mail</i>3</InertiaLink></div>
