...
const Asignacion = ({ curso, modulo, asignacion, alumnos, nAlumnos, nEntregas, comments }) => {
            ...
            <div className="row">
                ...
                <div className="col s12 div_asignacion_mod">
                    ...
                    <div className="col s12 div_cabecera">
                        ...
                        <a className="col s12 m1 l1 xl1 div-comments tooltipped" data-position="top" data-tooltip="Comentarios" onClick={handleVisibleC}><i className="material-icons">forum</i>{comments && comments.length > 0 ? comments.length : 0}</a>
                    </div>
                ...
                {values.visible &&
                    <Comments idCurso={curso.id} idModulo={modulo.id} idEntrada={asignacion.id} comments={comments} handleVisibleC={handleVisibleC} idTeacher={curso.teacher.id} />
                }
