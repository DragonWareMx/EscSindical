                        ...
                        <div className="card-content">
                            ...
                            <div className="row" style={{"marginBottom":"0px"}}>
                                <div className="col s12" style={{ "marginBottom": "10px"}}>
                                    ...
                                    <div className="col s1"><a className='dropdown-trigger'  data-target='dropdown-option-student'><i className="material-icons" style={{"color":"#727272", "fontSize":"22px"}}>more_vert</i></a></div>
                                ...
                                <div className="col s10 m3 l2">
                                    <InertiaLink href={route('cursos.informacion',cursos.id)}><img src={cursos.images && cursos.images.length>0 && "/storage/imagenes_curso/"+cursos.images['0'].imagen} className="img-course" style={{"width":"100%"}} /></InertiaLink>
                                </div>
