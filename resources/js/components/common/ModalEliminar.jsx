    ...
    return (
        <div id="modalEliminar" className="modal">
            <div className="modal-content">
                <h4 style={{"color":"red"}}>Eliminar {tipo} {nombre}</h4>
                ...
                <InertiaLink href={url} method="delete" as="button" type="button"  className="modal-close waves-effect waves-green btn-flat" style={{"color":"red"}}>Eliminar</InertiaLink>
            </div>
        </div>
    )
}
